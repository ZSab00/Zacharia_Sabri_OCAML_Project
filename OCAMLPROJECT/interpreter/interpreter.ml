    ...
    match num1 with 
       |Num(n1) ->
           (
              ...
              | _-> Div(num1,(step num2))

           )
          
       |_-> Div((step num1),num2)
 ...
 *)
   ...
   |RaiseDivByZero(t, RaiseDivByZero(t1, v))->RaiseDivByZero(t1,v) (*        *)
   |If(RaiseDivByZero(t, v),e2,e3)-> RaiseDivByZero(t, v)
   |IsZero(RaiseDivByZero(t, v))->RaiseDivByZero(t, v)
   |Plus(RaiseDivByZero(t, v),e2)->RaiseDivByZero(t, v)
   |Plus(e1,RaiseDivByZero(t, v))->RaiseDivByZero(t, v)
   |Mult(e1,RaiseDivByZero(t, v))->RaiseDivByZero(t, v)
   |Mult(RaiseDivByZero(t, v),e2)->RaiseDivByZero(t, v)
   |Apply(RaiseDivByZero(t, v),e2)->RaiseDivByZero(t, v)
   |Apply(e1,RaiseDivByZero(t, v))->RaiseDivByZero(t, v)
